...
# Initialize the data
inputs.append(grpcclient.InferInput('features', [1, 8], "FP32"))
inputs[0].set_data_from_numpy(input_data)

outputs.append(grpcclient.InferRequestedOutput('predictions'))
...
predictions_data = results.as_numpy('predictions')
